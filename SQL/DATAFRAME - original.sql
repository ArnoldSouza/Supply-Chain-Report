...
DECLARE @filial varchar(2) = '02'
DECLARE @armazem varchar(2) = '21'
DECLARE @codigo varchar(8) = '02500727'
DECLARE @dateFrom datetime = DATEADD(DAY,-365,CONVERT(DATE, GETDATE()))
...
FROM @dates
	LEFT JOIN #movimentos ON datas = #movimentos.DT
GROUP BY datas
ORDER BY datas
